   ...
   for(i=limit;i<rates_total && !IsStopped();i++)
     {
      ...
      Comment("Index: ",IntegerToString(i),"\n", 
           "HaOpen: "  ,DoubleToString(haOpen,Digits()),"\n", 
           "HaHigh: "  ,DoubleToString(haHigh,Digits()),"\n", 
           "HaLow: "   ,DoubleToString(haLow,Digits()),"\n", 
           "HaClose: " ,DoubleToString(haClose,Digits()),"\n" 
           ); 
      //--- set candle color
