            ...
            if (MyMACDValue2 > MyMACDValue3)
               {
                  ...
                  trade.Sell(0.1,_Symbol,0,0,Bid-200*_Point,statusComment);
                  statusComment = "";
               }
            if (JJ >= noTrade)
               {
                  oldData = MyMACDValue1;
               }
            JJ = JJ+1;     
         }
      else
         {
            Print("++++FBuy"," ",MyMACDValue1," ",MyMACDValue2);
            if (MyMACDValue2 < MyMACDValue3)
               {
                  ...
                  trade.Buy(0.1,_Symbol,0,0,Ask+200*_Point,statusComment);
                  statusComment = "";
               }
            if (JJ >= noTrade)
               {
